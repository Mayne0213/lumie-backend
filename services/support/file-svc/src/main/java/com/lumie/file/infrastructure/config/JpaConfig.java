package com.lumie.file.infrastructure.config;

import com.lumie.file.infrastructure.tenant.TenantConnectionProvider;
...
@Configuration
@EnableJpaAuditing
@EnableJpaRepositories(basePackages = "com.lumie.file.adapter.out.persistence")
