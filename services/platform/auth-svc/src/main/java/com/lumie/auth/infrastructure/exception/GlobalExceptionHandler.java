...
import com.lumie.auth.application.service.AuthCommandService.InvalidCredentialsException;
import com.lumie.auth.application.service.AuthCommandService.InvalidTokenException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCredentials(InvalidCredentialsException e) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ErrorResponse.of(AuthErrorCode.INVALID_CREDENTIALS.getCode(), e.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleInvalidToken(InvalidTokenException e) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ErrorResponse.of(AuthErrorCode.INVALID_TOKEN.getCode(), e.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleIllegalState(IllegalStateException e) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ErrorResponse.of(AuthErrorCode.TENANT_INACTIVE.getCode(), e.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleMissingHeader(MissingRequestHeaderException e) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of("C002", "Missing required header: " + e.getHeaderName()));
    }
