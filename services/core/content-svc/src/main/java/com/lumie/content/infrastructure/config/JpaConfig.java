package com.lumie.content.infrastructure.config;

import com.lumie.content.infrastructure.tenant.TenantConnectionProvider;
import com.lumie.content.infrastructure.tenant.TenantIdentifierResolver;
...
@Configuration
@EnableJpaAuditing
@EnableJpaRepositories(basePackages = "com.lumie.content.adapter.out.persistence")
