package com.lumie.spreadsheet.infrastructure.config;

import com.lumie.spreadsheet.infrastructure.tenant.TenantConnectionProvider;
...
@Configuration
@EnableJpaAuditing
@EnableJpaRepositories(basePackages = "com.lumie.spreadsheet.adapter.out.persistence")
